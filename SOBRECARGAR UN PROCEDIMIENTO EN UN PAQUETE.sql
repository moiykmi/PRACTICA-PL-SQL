...
PACKAGE BODY PACK2 AS
  ...
  X NUMBER;
  BEGIN
    -- TAREA: Se necesita implantación para FUNCTION PACK2.COUNT_EMPLOYEES
  ...
  BEGIN
    ...
    SELECT COUNT(*) INTO X FROM EMPLOYEES A , DEPARTMENTS B
        WHERE DEPARTMENT_NAME = 'ID' AND A.DEPARTMENT_ID = B.DEPARTMENT_ID;
    RETURN X;
  END COUNT_EMPLOYEES;
...
-- LLAMAR AL PAQUETE
/**
    LA FUNCION SE PUEDE LLAMAR SEGUN LA VARIABLE QUE LE ENVIE ESTO SOBREACRGARA EL METODO 
    (FUNCION COUNT_EMPLOYEES)
**/
BEGIN
